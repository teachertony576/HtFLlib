...
nohup python -u main.py   -lr 0.01 -jr 1 -lbs 10 -ls 1 -nc 20 -nb 100 -slr 0.001 -data Cifar100-PathologicalSetting -m HtFE8 -fd 512 -did 3 -algo FedTGP_PAL -pbs 10 -lam 10 -se 100 -mart 30 -gr 1000 > total-Cifar100-PathologicalSetting-HtFE8-fd=512-FedTGP_PAL-Cifa10_public-1000-PED.out 2>&1 &
nohup python -u main.py  -t 3  -lr 0.01 -jr 1 -lbs 10 -ls 1 -nc 20 -nb 100 -slr 0.001 -data Cifar100-dir -m HtFE8 -fd 512 -did 0 -algo FedMD -pbs 10 -lam 10 -se 100 -mart 30 -gr 500 > total-Cifar100-dir-HtFE8-fd=512-FedMD-Cifa10_public.out 2>&1 &
